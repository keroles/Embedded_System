...
extern void LCD_check_lcd_isbusy(void);
extern void LCD_lcd_kick (void);
extern void LCD_Send_A_Command(unsigned char command);
extern void LCD_Send_A_Character(unsigned char character);
extern void LCD_Send_A_String(char *string);
extern void LCD_lcd_init(void);
extern void LCD_clear_screen ();
extern void LCD_GotoXY(unsigned char line, unsigned char position );
extern void LCD_display_number (int Number );
extern void LCD_display_real_number (double  Number );
extern void LCD_clear_character();
extern void LCD_clear_sec_line();
